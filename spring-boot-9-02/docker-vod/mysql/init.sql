...
CREATE TABLE `artpiece_exhibition`
(
    `artpiece_id`  int DEFAULT NULL,
    `exhibition_id` int DEFAULT NULL
);

INSERT INTO `exhibition`(`id`, `logo`, `name`)
...
INSERT INTO `artpiece`(`id`, `poster`, `rating`, `title`, `artist_id`)
...
INSERT INTO `artpiece_exhibition`(`artpiece_id`, `exhibition_id`)
VALUES ('1', '1');
INSERT INTO `artpiece_exhibition`(`artpiece_id`, `exhibition_id`)
VALUES ('1', '3');
INSERT INTO `artpiece_exhibition`(`artpiece_id`, `exhibition_id`)
