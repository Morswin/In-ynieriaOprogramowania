    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http.csrf().disable()
                .authorizeHttpRequests(request-> request
                        .requestMatchers(HttpMethod.POST, "/webapi/artpieces").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/webapi/exhibitions").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/webapi/exhibitions/**").authenticated()
